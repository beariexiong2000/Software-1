...
if talk == "Yes":
    ...
    print("Let's hiking for a while and move on!")
...
print(f"Final Team members: {team}")
final_words = ""
if trust_score >= 60:
    ...
    final_words = "Ending 3: Forced team. The team walk into the journey under tension and mistrust."
